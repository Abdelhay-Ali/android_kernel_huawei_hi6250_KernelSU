...
#define KBASE_IOCTL_SET_RENDER_THREAD_PRIO \
	_IOW(KBASE_IOCTL_TYPE, 29, struct kbase_ioctl_render_prio_values)

#if 0
//disable vr HISI extensions
...
#define KBASE_IOCTL_MAP_IOVA \
	_IOW(KBASE_IOCTL_TYPE, 30, union kbase_ioctl_mem_iova)

#define KBASE_IOCTL_UMAP_IOVA \
	_IOW(KBASE_IOCTL_TYPE, 31, union kbase_ioctl_mem_iova)
#endif
/**********************************************************************/
