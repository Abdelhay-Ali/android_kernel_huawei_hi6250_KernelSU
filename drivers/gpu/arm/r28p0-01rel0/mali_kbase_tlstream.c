		...
		size_t     len)
{
	...
	memcpy(&buffer[pos], bytes, len);/* unsafe_function_ignore: memcpy */
		...
		size_t     max_write_size)
{
	...
	memcpy(&buffer[pos], &string_len, sizeof(string_len));/* unsafe_function_ignore: memcpy */
		...
		int                   numbered)
{
	...
	memcpy(&buffer[0],             &word0, sizeof(word0));/* unsafe_function_ignore: memcpy */
	memcpy(&buffer[sizeof(word0)], &word1, sizeof(word1));/* unsafe_function_ignore: memcpy */
}
		...
		size_t data_size)
{
	...
	memcpy(&word1, &buffer[sizeof(word0)], sizeof(word1));/* unsafe_function_ignore: memcpy */
...
static void kbasep_tlstream_packet_number_update(char *buffer, u32 counter)
{
	...
	memcpy(&buffer[PACKET_HEADER_SIZE], &counter, sizeof(counter));/* unsafe_function_ignore: memcpy */
}
