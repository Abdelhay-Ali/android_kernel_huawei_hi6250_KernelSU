...
#define HISI_RESERVED_FASTBOOT_DTB_PHYMEM_BASE (0x5C000000)
#define HISI_RESERVED_FASTBOOT_DTB_PHYMEM_SIZE (0x1000000)
#define HISI_RESERVED_FASTBOOT_AVB_HEAP_PHYMEM_BASE 0x44000000
#define HISI_RESERVED_FASTBOOT_AVB_HEAP_PHYMEM_SIZE (0x5C000000 - 0x44000000)
#define HISI_RESERVED_DTB_PHYMEM_BASE 0x07A00000
#define HISI_RESERVED_DTB_PHYMEM_SIZE (0x07B00000 - 0x07A00000)
#define HISI_RESERVED_BOOT_CAN_RUN_BASE 0x400000
#define HISI_RESERVED_BOOT_CAN_RUN_END 0x20000000
...
#define HISI_RESERVED_HIFI_PHYMEM_SIZE (0x35E00000 - 0x35400000)
#define HISI_RESERVED_BL31_PHYMEM_BASE 0x35E00000
#define HISI_RESERVED_BL31_PHYMEM_SIZE (0x35EC0000 - 0x35E00000)
