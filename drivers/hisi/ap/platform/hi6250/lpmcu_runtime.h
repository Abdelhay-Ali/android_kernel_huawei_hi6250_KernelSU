...
enum {
 WITH_MODEM_OFFSET = 0,
 WITH_INSIDE_CODEC_OFFSET = 1,
 LOWPM_SHOW_OFFSET = 3,
 LOWPM_CFG_OFFSET = 4,
};
#define IS_MODEM ((u8)BIT(WITH_MODEM_OFFSET))
#define IS_INSIDE_CODEC ((u8)BIT(WITH_INSIDE_CODEC_OFFSET))
...
#define RUNTIME_HIFREQ_HOTPLUG_FLAG_ADDR (RUNTIME_VAR_BASE + 0x05C)
#define HIFREQ_HOTPLUG_FLAG (WORD_REF(RUNTIME_HIFREQ_HOTPLUG_FLAG_ADDR))
