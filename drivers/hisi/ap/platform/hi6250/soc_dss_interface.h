...
#define AO_IOC_BASE (0xFFF11000)
#define IOC_BASE (0xE896C000)
#define GPIO27_BASE (0xFFF10000)
#define GPIO26_BASE (0xFFF0F000)
#define GPIO25_BASE (0xFFF0E000)
#define GPIO24_BASE (0xFFF0D000)
#define GPIO23_BASE (0xFFF0C000)
#define GPIO22_BASE (0xFFF0B000)
#define GPIO0_BASE (0xE8A0B000)
#define GPIO1_BASE (0xE8A0C000)
#define GPIO2_BASE (0xE8A0D000)
#define GPIO3_BASE (0xE8A0E000)
#define GPIO4_BASE (0xE8A0F000)
#define GPIO5_BASE (0xE8A10000)
#define GPIO6_BASE (0xE8A11000)
#define GPIO7_BASE (0xE8A12000)
#define GPIO8_BASE (0xE8A13000)
#define GPIO9_BASE (0xE8A14000)
#define GPIO10_BASE (0xE8A15000)
#define GPIO11_BASE (0xE8A16000)
#define GPIO12_BASE (0xE8A17000)
#define GPIO13_BASE (0xE8A18000)
#define GPIO14_BASE (0xE8A19000)
#define GPIO15_BASE (0xE8A1A000)
#define GPIO16_BASE (0xE8A1B000)
#define GPIO17_BASE (0xE8A1C000)
#define GPIO18_BASE (0xE8A1D000)
#define GPIO19_BASE (0xE8A1E000)
#define GPIO20_BASE (0xE8A1F000)
#define GPIO21_BASE (0xE8A20000)
#define PEREN0 (0x000)
...
#define MCTL_SECU_OS_EN (0x0004)
#define MCTL_RCH0_FLUSH_EN_SECU (0x0010)
#define MCTL_RCH1_FLUSH_EN_SECU (0x00140)
#define MCTL_PAY_SECU_FLUSH_EN (0x0018)
#define MCTL_RCH3_FLUSH_EN_SECU (0x001C)
#define MCTL_RCH4_FLUSH_EN_SECU (0x0020)
#define MCTL_RCH5_FLUSH_EN_SECU (0x0024)
#define MCTL_RCH6_FLUSH_EN_SECU (0x0028)
#define MCTL_RCH7_FLUSH_EN_SECU (0x002C)
#define MCTL_WCH0_FLUSH_EN_SECU (0x0030)
#define MCTL_WCH1_FLUSH_EN_SECU (0x0034)
#define MCTL_OV0_FLUSH_EN_SECU (0x0038)
