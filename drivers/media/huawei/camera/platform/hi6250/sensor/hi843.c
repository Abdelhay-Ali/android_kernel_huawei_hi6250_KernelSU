...
struct sensor_power_setting hi843_power_up_setting[] = {
...
struct sensor_power_setting hi843_power_down_setting[] = {
    //SCAM RST
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
...
struct sensor_power_setting hi843_power_up_setting_dvdd120[] = {
    //disable main camera reset
    {
        .seq_type = SENSOR_SUSPEND,
        .config_val = SENSOR_GPIO_LOW,
...
struct sensor_power_setting hi843_power_down_setting_dvdd120[] = {
    //SCAM RST
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
...
static sensor_t s_hi843 =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(hi843_power_up_setting),
            .power_setting = hi843_power_up_setting,
    },
...
int hi843_power_up(hwsensor_intf_t* si)
{
    ...
    ret = hw_sensor_power_up_config(s_hi843.dev, sensor->board_info);
    if (0 == ret ){
...
static int32_t hi843_platform_probe(struct platform_device* pdev)
{
    ...
    if (pdev->dev.of_node) {
		...
		if(DVDD120V == s_hi843.board_info->ldo_diverse){
			...
			s_hi843.power_setting_array.size = ARRAY_SIZE(hi843_power_up_setting_dvdd120);
			s_hi843.power_setting_array.power_setting = hi843_power_up_setting_dvdd120;
			s_hi843.power_down_setting_array.size = ARRAY_SIZE(hi843_power_down_setting_dvdd120);
			s_hi843.power_down_setting_array.power_setting = hi843_power_down_setting_dvdd120;
		}
    } else {
...
{
    hwsensor_unregister(Sensor2Pdev(s_hi843));
