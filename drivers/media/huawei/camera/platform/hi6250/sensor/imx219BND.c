...
struct mutex imx219BND_power_lock;
atomic_t volatile imx219BND_powered = ATOMIC_INIT(0);
static sensor_t s_imx219BND =
{
    ...
    .p_atpowercnt = &imx219BND_powered,
};
...
int imx219BND_config(hwsensor_intf_t* si, void  *argp)
{
    ...
    switch(data->cfgtype){
        case SEN_CONFIG_POWER_ON:
            mutex_lock(&imx219BND_power_lock);
            ...
            /*lint -e455 -esym(455,*)*/
            mutex_unlock(&imx219BND_power_lock);
            /*lint -e455 +esym(455,*)*/
            break;
...
static int32_t imx219BND_platform_probe(struct platform_device* pdev)
{
    ...
    mutex_init(&imx219BND_power_lock);
...
{
    hwsensor_unregister(Sensor2Pdev(s_imx219BND));
