...
struct sensor_power_setting hw_imx576_power_up_setting[] = {
...
struct sensor_power_setting hw_imx576_power_down_setting[] = {
...
static sensor_t s_imx576 =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(hw_imx576_power_up_setting),
            .power_setting = hw_imx576_power_up_setting,
     },
    .power_down_setting_array = {
            .size = ARRAY_SIZE(hw_imx576_power_down_setting),
            .power_setting = hw_imx576_power_down_setting,
    },
...
int imx576_config(hwsensor_intf_t* si, void  *argp)
{
    ...
    static bool imx576_power_on = false;
...
{
    cam_info("enter %s",__func__);
    return platform_driver_probe(&s_imx576_driver, imx576_platform_probe);
}
