...
char const* ov12a10hybird_get_name(hwsensor_intf_t* si);
int ov12a10hybird_config(hwsensor_intf_t* si, void  *argp);
int ov12a10hybird_power_up(hwsensor_intf_t* si);
int ov12a10hybird_power_down(hwsensor_intf_t* si);
int ov12a10hybird_match_id(hwsensor_intf_t* si, void * data);
int ov12a10hybird_csi_enable(hwsensor_intf_t* si);
int ov12a10hybird_csi_disable(hwsensor_intf_t* si);
...
struct sensor_power_setting hw_ov12a10hybird_power_up_setting[] = {
    ...
    {
        .seq_type = SENSOR_MCLK,
        .sensor_index = SENSOR_INDEX_2,/* clk for back_sub_camera */
        .delay = POWER_DELAY_1,/* meet sensor spec requirement dealy 1 ms */
    },
    ...
    //MCAM0 reset
    {
        ...
        .config_val = SENSOR_GPIO_HIGH,
        .sensor_index = SENSOR_INDEX_INVALID,
        .delay = POWER_DELAY_6,/* meet sensor spec requirement dealy 6 ms */
    },
...
struct sensor_power_setting hw_ov12a10hybird_power_down_setting[] = {
...
atomic_t volatile ov12a10hybird_powered = ATOMIC_INIT(0);
struct mutex ov12a10hybird_power_lock;
sensor_t s_ov12a10hybird =
{
    .intf = { .vtbl = &s_ov12a10hybird_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(hw_ov12a10hybird_power_up_setting),
            .power_setting = hw_ov12a10hybird_power_up_setting,
     },
    .power_down_setting_array = {
            .size = ARRAY_SIZE(hw_ov12a10hybird_power_down_setting),
            .power_setting = hw_ov12a10hybird_power_down_setting,
    },
    .p_atpowercnt = &ov12a10hybird_powered,
};
...
{
    {
        .compatible = "huawei,ov12a10hybird",
        ...
        void  *argp)
{
    ...
    switch(data->cfgtype){
        case SEN_CONFIG_POWER_ON:
            if (mutex_lock_interruptible(&ov12a10hybird_power_lock))
               return -ERESTARTSYS;
             if (!power_on_status){
            ...
            /*lint -e455 -esym(455,*)*/
            mutex_unlock(&ov12a10hybird_power_lock);
            /*lint -e455 +esym(455,*)*/
            break;
        ...
        struct platform_device* pdev)
{
    ...
    id = of_match_node(s_ov12a10hybird_dt_match, np);
    if (!id) {
    ...
    mutex_init(&ov12a10hybird_power_lock);
    sensor->dev = &pdev->dev;
