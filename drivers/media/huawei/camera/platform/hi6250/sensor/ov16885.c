...
int ov16885_config(hwsensor_intf_t* si, void  *argp);

static struct platform_device *s_pdev = NULL;
static sensor_t *s_sensor = NULL;
struct sensor_power_setting hw_ov16885_power_up_setting[] = {
...
struct sensor_power_setting hw_ov16885_power_down_setting[] = {
...
static sensor_t s_ov16885 =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(hw_ov16885_power_up_setting),
            .power_setting = hw_ov16885_power_up_setting,
     },
    .power_down_setting_array = {
            .size = ARRAY_SIZE(hw_ov16885_power_down_setting),
            .power_setting = hw_ov16885_power_down_setting,
    },
    .p_atpowercnt = &ov16885_powered,
};

static const struct of_device_id s_ov16885_dt_match[] =
{
    {
...
char const* ov16885_get_name(hwsensor_intf_t* si)
{
...
int ov16885_power_up(hwsensor_intf_t* si)
{
    int ret          = 0;
    sensor_t* sensor = NULL;
...
int ov16885_power_down(hwsensor_intf_t* si)
{
    int ret          = 0;
    sensor_t* sensor = NULL;
...
int ov16885_csi_enable(hwsensor_intf_t* si)
{
    (void)si;
    return 0;
}

int ov16885_csi_disable(hwsensor_intf_t* si)
{
    (void)si;
    return 0;
}
...
int ov16885_config(hwsensor_intf_t* si, void  *argp)
{
    ...
    static bool ov16885_power_on = false;
...
static int32_t ov16885_platform_probe(struct platform_device* pdev)
{
    ...
    if (0 != rc){
        ...
        goto ov16885_sensor_probe_fail;
    }
    s_pdev = pdev;
