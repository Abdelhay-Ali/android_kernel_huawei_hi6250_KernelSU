...
struct sensor_power_setting hw_ov20880_V3_power_up_setting[] = {
...
struct sensor_power_setting hw_ov20880_V3_power_down_setting[] = {
    //SCAM RST
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
...
sensor_t s_ov20880_v3 =
{
    .intf = { .vtbl = &s_ov20880_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(hw_ov20880_V3_power_up_setting),
            .power_setting = hw_ov20880_V3_power_up_setting,
     },
    .power_down_setting_array = {
            .size = ARRAY_SIZE(hw_ov20880_V3_power_down_setting),
            .power_setting = hw_ov20880_V3_power_down_setting,
     },
...
s_ov20880_dt_match[] =
{
    ...
    {
        .compatible = "huawei,ov20880_PICV3",
        .data = &s_ov20880_v3.intf,
    },
