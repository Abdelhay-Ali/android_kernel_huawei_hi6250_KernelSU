...
struct sensor_power_setting ov8856_power_up_setting[] = {
...
struct sensor_power_setting ov8856_power_down_setting[] = {
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
        .sensor_index = SENSOR_INDEX_INVALID,
...
struct sensor_power_setting ov8856_power_up_setting_dvdd120[] = {
    //disable main camera reset
    {
        .seq_type = SENSOR_SUSPEND,
        .config_val = SENSOR_GPIO_LOW,
...
struct sensor_power_setting ov8856_power_down_setting_dvdd120[] = {
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
        .sensor_index = SENSOR_INDEX_INVALID,
...
static sensor_t s_ov8856 =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(ov8856_power_up_setting),
            .power_setting = ov8856_power_up_setting,
     },
...
int ov8856_power_up(hwsensor_intf_t* si)
{
    ...
    ret = hw_sensor_power_up_config(s_ov8856.dev, sensor->board_info);
    if (0 == ret ){
...
static int32_t ov8856_platform_probe(struct platform_device* pdev)
{
    ...
    if (pdev->dev.of_node) {
		...
		if(DVDD120V == s_ov8856.board_info->ldo_diverse){
			...
			s_ov8856.power_setting_array.size = ARRAY_SIZE(ov8856_power_up_setting_dvdd120);
			s_ov8856.power_setting_array.power_setting = ov8856_power_up_setting_dvdd120;
			s_ov8856.power_down_setting_array.size = ARRAY_SIZE(ov8856_power_down_setting_dvdd120);
			s_ov8856.power_down_setting_array.power_setting = ov8856_power_down_setting_dvdd120;
		}
    } else {
...
{
    hwsensor_unregister(Sensor2Pdev(s_ov8856));
